...
function wc_measurement_price_calculator_admin_init() {
	...
	if ( 'post-new.php' == $pagenow || 'post.php' == $pagenow || is_ajax() ) include_once( wc_measurement_price_calculator()->get_plugin_path() . '/admin/post-types/writepanels/writepanels-init.php' );
}
