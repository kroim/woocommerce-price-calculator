...
function wc_price_calculator_product_rates_panel_tab() {
	echo '<li class="measurement_tab hide_if_grouped"><a href="#measurement_product_data">' . __( 'Measurement', 'woocommerce-measurement-price-calculator' ) . '</a></li>';
}
...
function wc_price_calculator_product_rates_panel_content() {
	...
	<div id="measurement_product_data" class="panel woocommerce_options_panel">
		...
		echo '<div id="dimension_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_dimension_length_fields" style="display:none;">';
				...
				woocommerce_wp_text_input( array(
					...
					'description'   => __( 'Use a single number to set a fixed value for this field on the frontend, or a comma-separated list of numbers to create a select box for the customer to choose between.  Example: 1/8, .5, 2', 'woocommerce-measurement-price-calculator' ),
					'desc_tip'      => true,
				) );
			echo '</div>';
			echo '<hr/>';
		...
		woocommerce_wp_text_input( array(
			'id'            => '_measurement_area-linear_length_min',
			'value'         =>  $settings['area-linear']['length']['min'],
			'wrapper_class' => '_measurement_pricing_calculator_fields',
			'label'         => __( 'Length Min', 'woocommerce-measurement-price-calculator' ),
			'description'   => __( 'Set min value', 'woocommerce-measurement-price-calculator' ),
			'desc_tip'      => true,
		) );
		woocommerce_wp_text_input( array(
			'id'            => '_measurement_area-linear_length_max',
			'value'         =>  $settings['area-linear']['length']['max'],
			'wrapper_class' => '_measurement_pricing_calculator_fields',
			'label'         => __( 'Length Max', 'woocommerce-measurement-price-calculator' ),
			'description'   => __( 'Set max value', 'woocommerce-measurement-price-calculator' ),
			'desc_tip'      => true,
		) );
...
*/
		woocommerce_wp_text_input( array(
			'id'            => '_measurement_area-linear_width_min',
			'value'         =>  $settings['area-linear']['width']['min'],
			'wrapper_class' => '_measurement_pricing_calculator_fields',
			'label'         => __( 'Width Min', 'woocommerce-measurement-price-calculator' ),
			'description'   => __( 'Set min value', 'woocommerce-measurement-price-calculator' ),
			'desc_tip'      => true,
		) );
		woocommerce_wp_text_input( array(
			'id'            => '_measurement_area-linear_width_max',
			'value'         =>  $settings['area-linear']['width']['max'],
			'wrapper_class' => '_measurement_pricing_calculator_fields',
			'label'         => __( 'Width Max', 'woocommerce-measurement-price-calculator' ),
			'description'   => __( 'Set max value', 'woocommerce-measurement-price-calculator' ),
			'desc_tip'      => true,
		) );
...
function wc_measurement_price_calculator_process_product_meta_measurement( $post_id, $post ) {
	...
	// skip saving the meta if this a caluclator type is not set i.e. not a measurement product
	if ( isset( $_POST['_measurement_price_calculator'] ) && '' === $_POST['_measurement_price_calculator'] ) {

		// check if post meta is set already
		if ( $settings = get_post_meta( $post_id, '_wc_price_calculator', true ) ) {
	...
	if ( 'no' == $is_virtual && 'grouped' != $product_type ) {
		...
		$settings['dimension']['length'] = array(
			...
			'options'  => explode( ',', trim( $_POST['_measurement_dimension_length_options'] ) ),
		);
		$settings['dimension']['width'] = array(
			...
			'options'  => explode( ',', trim( $_POST['_measurement_dimension_width_options'] ) ),
		);
		$settings['dimension']['height'] = array(
			...
			'options'  => explode( ',', trim( $_POST['_measurement_dimension_height_options'] ) ),
		);
		...
		$settings['area']['area'] = array(
			...
			'options'  => explode( ',', trim( $_POST['_measurement_area_options'] ) ),
		);
		...
		$settings['area-dimension']['length'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_area_length_options'] ) ),
		);
		$settings['area-dimension']['width'] = array(
			'label'    => $_POST['_measurement_area_width_label'],
			'unit'     => $_POST['_measurement_area_width_unit'],
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_area_width_options'] ) ),
		);
		...
		$settings['area-linear']['length'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_area-linear_length_options'] ) ),
			'min'  =>  trim( $_POST['_measurement_area-linear_length_min'] ),
			'max'  =>  trim( $_POST['_measurement_area-linear_length_max'] ),
		);
		$settings['area-linear']['width'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_area-linear_width_options'] ) ),
			'min'  =>  trim( $_POST['_measurement_area-linear_width_min'] ),
			'max'  =>  trim( $_POST['_measurement_area-linear_width_max'] ),
		);
		...
		$settings['area-surface']['length'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_area-surface_length_options'] ) ),
		);
		$settings['area-surface']['width'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_area-surface_width_options'] ) ),
		);
		$settings['area-surface']['height'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_area-surface_height_options'] ) ),
		);
		...
		$settings['volume']['volume'] = array(
			...
			'options'  => explode( ',', trim( $_POST['_measurement_volume_options'] ) ),
		);
		...
		$settings['volume-dimension']['length'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_volume_length_options'] ) ),
		);
		$settings['volume-dimension']['width'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_volume_width_options'] ) ),
		);
		$settings['volume-dimension']['height'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_volume_height_options'] ) ),
		);
		...
		$settings['volume-area']['area'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_volume_area_options'] ) ),
		);
		$settings['volume-area']['height'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_volume_area_height_options'] ) ),
		);
		...
		$settings['weight']['weight'] = array(
			...
			'options'  => explode( ',', trim( $_POST['_measurement_weight_options'] ) ),
		);
		...
		$settings['wall-dimension']['length'] = array(
			...
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_wall_length_options'] ) ),
		);
		$settings['wall-dimension']['width'] = array(
			'label'    => $_POST['_measurement_wall_width_label'],
			'unit'     => $_POST['_measurement_wall_width_unit'],
			'editable' => 'yes',
			'options'  => explode( ',', trim( $_POST['_measurement_wall_width_options'] ) ),
		);
