...
<table class="widefat wc-calculator-pricing-table">
	...
	<tr>
		...
		<th class="measurement-range-column">
			...
			<?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'Configure the starting-ending range, inclusive, of measurements to match this rule.  The first matched rule will be used to determine the price.  The final rule can be defined without an ending range to match all measurements greater than or equal to its starting range.', 'woocommerce-measurement-price-calculator' ) ); ?>
		</th>
		<th class="price-per-unit-column">
			...
			<?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'Set the price per unit for the configured range.', 'woocommerce-measurement-price-calculator' ) ); ?>
		</th>
		<th class="sale-price-per-unit-column">
			...
			<?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'Set a sale price per unit for the configured range.', 'woocommerce-measurement-price-calculator' ) ); ?>
		</th>
	</tr>
	</thead>
	<tbody>
