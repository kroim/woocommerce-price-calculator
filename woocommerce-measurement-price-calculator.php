...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.4.0', __( 'WooCommerce Measurement Price Calculator', 'woocommerce-measurement-price-calculator' ), __FILE__, 'init_woocommerce_measurement_price_calculator', array(
...
class WC_Measurement_Price_Calculator extends SV_WC_Plugin {
	...
	/** plugin text domain, DEPRECATED in 3.9.0 */
	 ...
	 *
	 * @since 3.10.0
	 * @return \WC_Price_Calculator_Cart The product loop instance
	 */
