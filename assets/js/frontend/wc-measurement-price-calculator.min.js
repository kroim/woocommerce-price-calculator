jQuery( document ).ready(function() {
    ...
    jQuery('#length_needed').on('keyup change', function() {

        var val = jQuery(this).val();
        var min = jQuery('#check_vaild_length_needed_min').val();
        var max = jQuery('#check_vaild_length_needed_max').val();
        var flag = jQuery('#check_flag_width_needed').val();

        if(parseInt(min)>parseInt(max)) max = min;

        if(parseInt(val)>=min && parseInt(val)<=max){
            jQuery('#check_flag_length_needed').val('1');
            jQuery("#length_needed").css("background-color", "green");
            if(flag == 1)  jQuery(':button[type="submit"]').prop('disabled', false);
            else jQuery(':button[type="submit"]').prop('disabled', true);
        }
        else{
            jQuery('#check_flag_length_needed').val('0');
            jQuery("#length_needed").css("background-color", "white");
            jQuery(':button[type="submit"]').prop('disabled', true);
        }
    ...
    jQuery('#width_needed').on('keyup change', function() {
        ...
        var val = jQuery(this).val();
        var min = jQuery('#check_vaild_width_needed_min').val();
        var max = jQuery('#check_vaild_width_needed_max').val();
        var flag = jQuery('#check_flag_length_needed').val();

        if(parseInt(min)>parseInt(max)) max = min;

        if(parseInt(val)>=min && parseInt(val)<=max){
            jQuery('#check_flag_width_needed').val('1');
            jQuery("#width_needed").css("background-color", "green");
            if(flag == 1)  jQuery(':button[type="submit"]').prop('disabled', false);
            else jQuery(':button[type="submit"]').prop('disabled', true);
        }
        else{
            jQuery('#check_flag_width_needed').val('0');
            jQuery("#width_needed").css("background-color", "white");
            jQuery(':button[type="submit"]').prop('disabled', true);
        }
